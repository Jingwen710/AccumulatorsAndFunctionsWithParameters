...
# ----------------------------------------------------------------------
def even_better_draw_circles(radii, number, center_x, center_y, speed):
    window = rg.RoseWindow(400, 400)
    ...
    for k in range(number + 1):
        ...
        circle.attach_to(window)
        window.render(speed)  # Pauses for some seconds after rendering.

    window.close_on_mouse_click()


def run_test_even_better_draw_circles():
    even_better_draw_circles(10, 5, 100, 100, 0.05)
    even_better_draw_circles(20, 8, 200, 200, 0.1)
    even_better_draw_circles(30, 20, 150, 150, 0.02)
