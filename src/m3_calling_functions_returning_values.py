...
def digits_in_cube(n):
    ...
    # ------------------------------------------------------------------
    cube_value = n ** 3
    digits = sum_of_digits(cube_value)
    return digits
...
def digits_in_power(n, k):
    ...
    # ------------------------------------------------------------------
    power_value = n ** k
    return sum_of_digits(power_value)
...
def fancy_sums_of_digits(n):
    ...
    ####################################################################
    # ------------------------------------------------------------------
    x_value = sum_of_digits(n ** 1000)
    y_value = sum_of_digits(n ** 999)
    sum_value = x_value ** y_value
    return sum_of_digits(sum_value)
